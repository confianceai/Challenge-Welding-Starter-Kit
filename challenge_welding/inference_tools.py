...
class TestAIComponent:
    ...
    Score computation functions are not provided here, but they all rely only the inference results as input. Thus if the inference process is working
    it ensures that the scores computations on your Ai component will work too.
